...
/**
 * Implement the XPath 'namespace-uri' function.
 * <p>
 * See <a href="http://www.w3.org/TR/xpath#function-namespace-uri">http://www.w3.org/TR/xpath#function-namespace-uri</a>.
 *
 */
...
//    Context ctx = (Context)args.get(0);
    ...
    else if (!(args.get(0) instanceof NodeSet))
    {
      ...
      throw new XPathRuntimeException(MessageFormat.format(msg, new Object []{ "namespace-uri" })); //$NON-NLS-1$
    }
    else
    {
    ...
    return en != null ? en.getNamespaceURI() : ""; //$NON-NLS-1$
  }
